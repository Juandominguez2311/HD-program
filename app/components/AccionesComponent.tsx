...
import { Accesories } from "@prisma/client";

interface AccionesComponent {
  data: Accesories;
  key: string;
}
const styles = {
...
export default function AccionesComponent({ data, key }: AccionesComponent) {
        ...
        <div className="cursor-pointer hover:opacity-80 items-center">
          <div>
            <Image
              ...
              onClick={() => router.push(`/accesory/${data.id}`)}
            />
          </div>
